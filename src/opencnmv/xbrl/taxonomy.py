...
ESEF_TAXONOMY = {
    ...
    # Evidence: preserved packages declare the
    # esma.europa.eu/taxonomy/2022-03-24/esef_cor.xsd entry point for
    # FY2023 and FY2024 filings, and the 2024-03-27 entry point for
    # FY2025.
    "FY2023": {
