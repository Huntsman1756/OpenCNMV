...
## Pinned dependencies (`taxonomy_manifest.json`, 17 rows)
...
- `taxonomy_manifest.json` (17 rows), `evidence/` (2 ESMA packages, 1 CNMV package copy,
  8 xbrl.org files), `pin_taxonomies.ps1`
